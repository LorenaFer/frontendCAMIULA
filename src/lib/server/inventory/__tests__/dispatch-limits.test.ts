...
// ─── Motor de validación (copiado de dispatches.service.ts) ──────────────────
// Se extrae la lógica pura para testearla sin el mockFlags de servidor.

function validateDispatchLogic(
