  ...
  <div class="relative group">
      ...
      class="
        ...
        {previewUrl
          ...
          : error
            ...
            : 'border-border bg-canvas-subtle hover:border-border-strong'}
    ...
    >
      {#if previewUrl}
        ...
        />
      {:else}
        <svg class="w-8 h-8 text-ink-subtle" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
