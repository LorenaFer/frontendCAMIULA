<script lang="ts">
	import type { MedicationStatus } from '$domain/inventory/types.js';
...
<span
	class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium {styleMap[status]} {className}"
>
	{labelMap[status]}
</span>
