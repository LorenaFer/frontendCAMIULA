...
export const GET: RequestHandler = async ({ url, locals }) => {
	...
	const modules: Array<{ title: string; subtitle: string; href: string; keywords: string[]; permission?: string }> = [
		...
		{ title: 'Categorías', subtitle: 'Categorías de medicamentos', href: '/inventory/categories', keywords: ['categoria', 'clasificacion', 'tipo', 'antibiotico', 'analgesico'], permission: P.INVENTORY_WRITE },
		{ title: 'Kardex', subtitle: 'Movimientos de inventario', href: '/inventory/movements', keywords: ['kardex', 'movimiento', 'trazabilidad', 'entrada', 'salida', 'ajuste'], permission: P.INVENTORY_READ },
		{ title: 'Alertas de Stock', subtitle: 'Alertas de niveles críticos', href: '/inventory/alerts', keywords: ['alerta', 'stock', 'critico', 'agotado', 'nivel'], permission: P.INVENTORY_READ },
