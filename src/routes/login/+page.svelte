...
<svelte:head>
	...
	<meta name="description" content="Login to your hospital account" />
</svelte:head>

<div class="min-h-screen flex items-center justify-center bg-snow px-4">
	<!-- Background decoration -->
	<div class="absolute inset-0 overflow-hidden pointer-events-none">
		<div class="absolute -top-40 -right-40 w-80 h-80 bg-viking-100 rounded-full blur-3xl opacity-50"></div>
		<div class="absolute -bottom-40 -left-40 w-80 h-80 bg-viking-50 rounded-full blur-3xl opacity-50"></div>
	</div>
			...
			<CardBody class="p-6 sm:p-8">
				<form onsubmit={handleSubmit} class="space-y-5">
					...
					<div class="flex items-center justify-between">
						...
						<a
							href="#forgot"
							class="text-sm font-medium text-viking-600 hover:text-viking-700 transition-colors"
						>
							Forgot password?
						</a>
					</div>

					<Button type="submit" fullWidth size="lg" {isLoading}>
						Sign in
					</Button>
				</form>
